        ...
        <div className="container-app h-16 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-12 h-12 md:w-14 md:h-14 flex items-center justify-center transition-all duration-300 group-hover:scale-110 relative" style={{ zIndex: 10 }}>
              <img src="/logo-v1.png" alt="Ahorrito Logo" className="w-full h-full object-contain drop-shadow-[0_4px_8px_rgba(16,185,129,0.3)] transition-transform duration-300" />
            </div>
